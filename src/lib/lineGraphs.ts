...
export const LINE_GRAPH_TOPICS: Record<LineGraphTopic, LineGraphTopicInfo> = {
  ...
  'wavy-line': {
    ...
    method: '波線は「ここの数は飛ばすよ」というマーク。変化を大きく見せたいときに使う。例：体温36.5〜37.2℃の変化を大きく見せる',
    methodEn: 'Wavy line means "we skipped these numbers." Used to make changes look bigger. Example: Body temperature 36.5-37.2°C shown larger',
